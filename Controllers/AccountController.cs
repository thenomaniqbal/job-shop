...
namespace JobShop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationSignInManager signInManager, ApplicationUserManager userManager/*, ApplicationRoleManager roleManager*/)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EmployerRegister(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FullName = model.FullName, PhoneNumber = model.PhoneNumber, Gender = model.Gender, CompanyName = model.CompanyName, CompanyId = model.CompanyId };
        ...
        //    if (ModelState.IsValid)
        //    {
        //        var user = new ApplicationUser { UserName = model.Email, FullName = model.UserName, Email = model.Email, PhoneNumber = model.PhoneNumber, Gender = model.Gender };
